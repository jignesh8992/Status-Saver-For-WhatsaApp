...
class AppRatingDialogView(context: Context) : LinearLayout(context), OnRatingBarChangedListener {
    ...
    private var ratingChangeListener: OnRatingBarChangedListener? = null
    ...
    fun setTitleText(title: String) {
        ...
        titleText.typeface= Typeface.createFromAsset(context.assets,"fonts/Montserrat-Bold.otf")
    }
    ...
    override fun onRatingChanged(rating: Int) {
     ...
     fun onRatingChangedListener(ratingChangeListener: OnRatingBarChangedListener) {
