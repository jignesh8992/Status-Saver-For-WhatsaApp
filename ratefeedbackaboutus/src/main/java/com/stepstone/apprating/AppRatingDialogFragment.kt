 ...
 * @see AppRatingDialog
 */
class AppRatingDialogFragment : DialogFragment(), OnRatingBarChangedListener {
    ...
    private fun setupAlertDialog(context: Context): AlertDialog {
        ...
        dialogView.onRatingChangedListener(this)
    ...
    override fun onRatingChanged(rating: Int) {
        listener?.onMoreThan4StarSelection(rating)
        dialog!!.dismiss()
    }
