...
import static com.stepstone.easy_feedback.components.DeviceInfo.Device.DEVICE_LANGUAGE;
        ...
        try {
            switch (device) {
                ...
                case DEVICE_TOTAL_MEMORY:
                    if (Build.VERSION.SDK_INT >= 16) return String.valueOf(getTotalMemory(activity));
