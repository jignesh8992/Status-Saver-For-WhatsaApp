...
import com.stepstone.widgets.JustifiedTextView;
import com.stepstone.widgets.TextViewJustify;
 ...
 * in an activity's {@link Activity#onCreate(Bundle)} method
 * <p>
...
public class AboutPage {
    ...
    public AboutPage addEmail(String email, String title) {
        ...
        emailElement.setIconDrawable(R.drawable.ic_gmail);
        emailElement.setTextColor(Color.BLACK);
    ...
    public AboutPage addFacebook(String id, String title) {
        ...
        facebookElement.setTextColor(Color.BLACK);
    ...
    public AboutPage addPlayStore(String id, String title) {
        ...
        playStoreElement.setIconDrawable(R.drawable.ic_playstore);
      //  playStoreElement.setIconTint(R.color.about_play_store_color);
        playStoreElement.setValue(id);
        playStoreElement.setTextColor(Color.BLACK);
    ...
    public AboutPage addInstagram(String id, String title) {
      ...
      //  instagramElement.setIconTint(R.color.about_instagram_color);
        ...
        instagramElement.setTextColor(Color.BLACK);
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_VIEW);
    ...
    /*    if (element.getTextColor()!=-1){
            textView.setTextColor(element.getTextColor());
        }else {
            textView.setTextColor(mContext.getResources().getColor(R.color.about_text_color));
        }*/
