    ...
    private class LoadPhotos extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if (Constant.TYPE_STATUS == Constant.TYPE_WHATSAPP_STATUS) {
                ...
                String folder_path = Constant.getPhotoPath2(mContext);
                list = FileHelper.loadFiles(folder_path);
            }


            ArrayList<String> temp = SortHelper.sortPhotos(list);
        ...
        protected void onPostExecute(Boolean isUpdate) {
            ...
            if (isUpdate) {
                if (photoList.size() > 0) {
                    ...
                    adapter = new ThumbAdapter(mContext, photoList, new RVClickListener() {
                        ...
                        public void onItemClick(int position) {
                            ...
                            try {
                                ...
                                Log.i(TAG_ADS, "View status InterstitialAd counter : " + adsCount);
                    ...
                    if (Constant.TYPE_STATUS == Constant.TYPE_WHATSAPP_STATUS) {
                        tvNoStatus.setText(R.string.no_photo);
                    } else {
                        tvNoStatus.setText(R.string.no_saved_photo);
                    }
